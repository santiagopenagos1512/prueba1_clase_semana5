...
LOOP:
    ;BTFSS ((INTCON) and 07Fh), 2 ; Verificar interrupcion de TMR0
    GOTO LOOP
...
CONFIG_TMR0:
    ...
    BCF ((OPTION_REG) and 07Fh), 5 ; TMR0 como temporarizador
    BCF ((OPTION_REG) and 07Fh), 3 ; prescalar a TMR0
    ...
    BCF ((INTCON) and 07Fh), 2 ; Limpieza bandera de interrupcion
    return
...
CONFIG_INT:
    ...
    BCF ((INTCON) and 07Fh), 2 ; Buena practica siempre limpiarla
    return
